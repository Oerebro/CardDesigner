...
public class VariableTabbedPane extends JTabbedPane{
    ...
    */
    ...
    private void addTabsWeaponOneHand(){
        ...
        add("Magic Foci",new ItemArtImageBrowser("resources/img/weapons/wands",440,350,1300,40,80).getScrollPane());
        add("Bows",new ItemArtImageBrowser("resources/img/weapons/bows",440,350,1300,40,80).getScrollPane());
        add("Whips",new ItemArtImageBrowser("resources/img/weapons/whips",440,350,1300,40,80).getScrollPane());
        ...
        add("Glaives",new ItemArtImageBrowser("resources/img/weapons/staves",440,350,1300,40,80).getScrollPane());
    }
